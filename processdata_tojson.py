...
def createJSONComplete():
        global list_of_data
        counter = 0
        b = open("dump1090/public_html/newjson/"+fname001+".json","w")
	b.write("[")
        for f in range(0,len(list_of_data)):
...
#			print "debug3"
			...
			curDataRecord = theData[curLine].split(":")[3:83]+[curStation]
...
listtanggal= listtanggal[17:-22]
#listtanggal=["150615-16"]
...
#		print datetime.now()
		print fname001
		print lastLine
		processdata(returnLinesAfter('log/log_adsb_server_'+ fname001 +".txt"))
#		processdata(returnLinesAfter('cobalog3.txt'))
#		print "debug1"
		createJSON()
		createJSONComplete()
#		print "debug2"
